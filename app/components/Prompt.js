...
export default function Prompt() {
  ...
  const CloseBtnSVG = () => (
    <svg className="fill-current h-6 w-6 text-gray-800" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      <title>Close</title>
      ...
      <div>
        <div className="flex pt-12 md:pt-6 justify-center items-center">
          <div className="md:hidden bg-blue-500 text-white p-2 rounded shadow-md fixed m-4 flex justify-center items-center space-x-6">
            <Image src="https://www.orb.ac/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Forb-logo-letter-black.7a11a7c5.png&w=256&q=75" alt="Orb App Icon" width={40} height={32} />
            <div>
        ...
        <div className="hidden md:block bg-gray-200 text-white p-2 rounded shadow-md fixed m-4 flex flex-col justify-center items-center px-12">
          <div className='flex justify-center items-center'>
            <Image src="https://www.orb.ac/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Forb-logo-letter-black.7a11a7c5.png&w=256&q=75" alt="Orb App Icon" width={32} height={32} className='mr-2' />
            <p className="text-gray-900 text-sm py-2">For a better experience, download our app</p>
          ...
          <div className='flex justify-start py-2'>
            <Link className="" href={`https://apps.apple.com/us/app/orb-everyday-web3-social-app/id1638461963`}>
              <Image src='https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Download_on_the_App_Store_Badge.svg/320px-Download_on_the_App_Store_Badge.svg.png' width={160} height={60} />
            </Link>
            <Link className="pl-4" href={`https://play.google.com/store/apps/details?id=app.orb.flutter`}>
              <Image src='https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Google_Play_Store_badge_EN.svg/320px-Google_Play_Store_badge_EN.svg.png' width={160} height={60} />
            </Link>
          </div>
        </div>
      </div>
